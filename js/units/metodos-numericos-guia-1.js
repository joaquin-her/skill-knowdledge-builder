/* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Contenido puro: el motor vive en js/engine.js. Para dar de alta otra unidad,
   copiá js/units/_plantilla.js — no hace falta tocar el motor.

   Todo va dentro de una IIFE a propósito: los scripts clásicos comparten el
   scope léxico, así que dos unidades con `M` a nivel global chocarían con
        ...
        preguntas: [
          {
            ...
            desarrollo: [
              ...
              { table: {
                ...
                rows: [
                  ['v)  $99-70(1{,}4) = 1$', '1,00000000', '19.699 %'],
